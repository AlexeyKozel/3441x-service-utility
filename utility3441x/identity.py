...
def complete_identity_switch_after_end(
    ...
    *,
    ...
    if identity_after.get("model") == plan.target_model:
        reboot_mode = "automatic"
    elif identity_after.get("model") == source_model:
        ...
        if (
            identity_after.get("serial") != expected_serial
            or identity_after.get("model") != plan.target_model
        ):
